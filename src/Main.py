...
def create_sheet():
    ...
    if reset == "yes" or reset == "y":
        print(
            "You are about to reset the students for tomorrow, do not create an attendance sheet again for today "
            "unless you want all students to be considered false!")
        print(
            "You will have to take all the students attendance again if you want to correct an error - or you can "
...
def rewrite_classes(updated_class):
    ...
    if exists:
        ...
        for a_class in classes_list:
            ...
            try:
                ...
                if updated_class.name != a_class.name:
                    ...
                    with open('classes/classes.pickle', 'ab') as classes:
                        ...
                        pickle.dump(updated_class, classes, protocol=pickle.HIGHEST_PROTOCOL)
            except:
                # catch exceptions
                pass
    else:
...
def create_class():
    ...
    try:
        ...
        this_class = input("What is the class name: ").lower()
        # assign the new class to a variable
        new_class = Class(this_class)
        ...
        # call create_class() again if an exception is caught
        create_class()
...
def add_student_to_class():
    ...
    the_class.add_student(input_2, input_2)
...
def activity_request():
    ...
    if input_1 == "1":
        ...
        print("Sorry, you have not entered a valid number.")
        activity_request()
